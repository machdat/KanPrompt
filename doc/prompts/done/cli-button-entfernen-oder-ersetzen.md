...
- **Datum:** 2026-03-15T19:15:00
- **Branch:** master
- **Ergebnis:** Erfolgreich

## Zusammenfassung

Option B umgesetzt: Der „📋 CLI"-Button wurde durch einen „📋 Workflow"-Button ersetzt, der die Workflow-Doku (`doc/prompts/README.md`) via Companion im Editor öffnet. Die alte `exportCliHelp()` Funktion mit dem jq-Cheat-Sheet wurde komplett entfernt.

## Geänderte Dateien

- `kanprompt.html` — Button-Label/onclick geändert, `exportCliHelp()` durch `openWorkflowDoc()` ersetzt (nutzt bestehende Companion `/open-editor` API)

## Abweichungen vom Prompt

- Option B statt der empfohlenen Option A gewählt (Entscheidung des Users)
- Öffnet `doc/prompts/README.md` (projektspezifische Workflow-Doku) statt `workflow/CLAUDE-backlog-section.md` (liegt nur im KanPrompt-Repo)
